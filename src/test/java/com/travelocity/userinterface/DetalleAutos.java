...
public class DetalleAutos {
    ...
    public static final Target SELECCIONAR_FECHA_ENTREGA = Target.the("selector de fecha de entrega").locatedBy("//button[contains(@aria-label, 'Fecha de entrega')]");
    ...
    public static final Target SELECT_HORA_DEVOLUCION = Target.the("select de horas de devolucion").locatedBy("//*[@id='Rental-cars-transportation']/div[2]/div[3]/div/select");
